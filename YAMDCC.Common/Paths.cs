...
public static class Paths
{
    ...
    public static readonly string ProjectRepo = "YAMDCC_Config/YAMDCC";
    ...
    private static string GetDataPath()
    {
        ...
        // 理由: YAMDCC 是 "SYSTEM 服务 + 用户 GUI" 架构, 两边必须读写同一份配置.
        ...
        // 迁移 2: YAMDCC v1.x/2.x/3.0-beta 里放在 LocalAppData 的配置 ->
    ...
    public static void EnsureTemplatesExtracted()
    {
        ...
        try
        {
            // 主 exe 程序集 (Paths 位于 YAMDCC.Common, 但 Common.cs 在单 exe 里
