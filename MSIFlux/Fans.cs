...
namespace MSIFlux.GUI
{
    public partial class Fans : RForm
    {
        ...
        public void SetConfig(MSIFlux_Config config, SettingsForm? settingsForm = null)
        {
            _config = config;
        ...
        private void ButtonImport_Click(object? sender, EventArgs e)
        {
            using (OpenFileDialog openFileDialog = new OpenFileDialog())
            {
                ...
                openFileDialog.InitialDirectory = MSIFlux.Common.Paths.Data;
                ...
                if (openFileDialog.ShowDialog() == DialogResult.OK)
                {
                    try
                    {
                        ...
                        {
                            _config = MSIFlux_Config.Load(openFileDialog.FileName);
                            LoadConfig();
                            ApplyConfig();
