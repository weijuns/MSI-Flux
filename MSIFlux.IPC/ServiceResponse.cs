...
public enum Response
{
    ...
    /// • Revison: The current MSIFlux service version, as a Git revision/hash.
    /// </para>
    /// </remarks>
    ServiceVer,
    /// <summary>
    ...
    KeyLightBright,
    /// <summary>
    /// Sent to all connected clients when the MSIFlux service
    /// reloads the current MSIFlux config (CurrentConfig.xml).
    /// </summary>
    /// <remarks>
    /// <para>
    /// This response's <see cref="ServiceResponse.Value"/> field includes
    ...
    ConfLoaded,
    /// <summary>
    /// The result of a <see cref="Command.GetGpuMode"/> command.
    /// </summary>
    /// <remarks>
    /// <para>
    /// This response's <see cref="ServiceResponse.Value"/> field includes
    /// the following data as an <see langword="int"/>:<br/>
    /// • Mode: 0 for Hybrid, 1 for Discrete.
    /// </para>
    /// </remarks>
    GpuModeResult,
}
