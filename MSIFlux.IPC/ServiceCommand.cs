...
/// be sent to the MSIFlux Service.
/// </summary>
public enum Command
{
    /// <summary>
    ...
    Nothing = 0,
    /// <summary>
    /// Get the MSIFlux Service version, as a Git revision hash.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    WriteECByte,
    /// <summary>
    /// Reloads and applys the MSIFlux config located at
    /// <c>C:\ProgramData\MSIFlux_Config\MSIFlux\CurrentConfig.xml</c>.
    /// </summary>
    ApplyConf,
    /// <summary>
    ...
    /// currently loaded MSIFlux config.
    /// </summary>
    /// <remarks>
    /// <para>
    /// This command expects the following argument as
    ...
    /// with a specified system fan in the currently loaded MSIFlux config.
    /// </summary>
    /// <remarks>
    /// <para>
    /// This command expects the following argument as
    ...
    /// range specified by the current MSIFlux config, or if keyboard backlight
    /// support straight up doesn't exist in the current MSIFlux config.
    /// </remarks>
    GetKeyLightBright,
    /// <summary>
    ...
    /// supported by the current MSIFlux config.
    /// </para>
    /// <para>
    /// This command expects the following argument as
    /// an <see langword="int"/>:<br/>
    ...
    SetPerfMode,
    /// <summary>
    /// Sets the GPU MUX mode (Hybrid or Discrete).
    ...
    /// This command expects the following argument as
    /// an <see langword="int">:<br/>
    /// • Mode: 0 for Hybrid (iGPU + dGPU), 1 for Discrete (dGPU only).
    /// </para>
    /// </remarks>
    SetGpuMode,
    /// <summary>
    /// Gets the current GPU MUX mode from EC registers.
    /// </summary>
    /// <remarks>
    /// <para>This command expects no arguments.</para>
    /// <para>
    /// The result is sent to the caller as a
    /// <see cref="Response.GpuModeResult"/> message.
    /// </para>
    /// </remarks>
    GetGpuMode,
}
...
/// <summary>
/// Represents a command to send to the MSIFlux Service.
/// </summary>
[MessagePackObject]
