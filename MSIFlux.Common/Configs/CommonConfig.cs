...
{
    /// <summary>
    /// Cached singleton instance to avoid repeated file I/O.
    /// </summary>
    private static CommonConfig? _instance;
    ...
    /// <summary>
    /// The path to the last MSIFlux config loaded by the config editor.
    /// </summary>
    [XmlElement]
    ...
    /// <summary>
    /// <see langword="true"/> to disable Full Blast when exiting the MSIFlux config
    ...
    /// <summary>
    /// <see langword="true"/> if the MSIFlux updater should update
    ...
    private void Save()
    {
        ...
        // Update cached instance after saving
        lock (_instanceLock)
        {
            _instance = this;
        }
